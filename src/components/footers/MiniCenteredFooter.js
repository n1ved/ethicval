...
const Container = tw(ContainerBase)`bg-blue-700 text-gray-100 -mx-8 -mb-8`
...
const Link = tw.a`border-b-2 border-transparent hocus:text-gray-300 hocus:border-gray-300 pb-1 transition duration-300 mt-2 mx-4 text-gray-200`;
